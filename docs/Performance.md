...
```sh
python3 tests/cli/test_headless.py \
  /tmp/mandelbrot-development/Build/Products/Release/Mandelbrot.app/Contents/MacOS/Mandelbrot
```
...
repeats it five times and saves the runs under `evidence/gpu-pipeline`.
...
[tests/precision](../benchmarks/reference-library/README.md); raw measurements are in
