...
Generate deliberately with: python3 tests/test_product_golden.py --record
Run normally with: python3 tests/test_product_golden.py APP
"""
import json
...
root = Path(__file__).parent / 'fixtures' / 'product'
